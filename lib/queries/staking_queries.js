...
exports.delegatorEventsQuery = exports.allTimeStatsQuery = exports.allTimePoolRewardsQuery = exports.allTimeDelegatorStatsQuery = exports.nextEpochDelegatorStakedQuery = exports.nextEpochDelegatorDepositedQuery = exports.currentEpochDelegatorStakedQuery = exports.currentEpochDelegatorDepositedQuery = exports.nextEpochPoolStatsQuery = exports.nextEpochPoolsStatsQuery = exports.currentEpochPoolStatsQuery = exports.currentEpochPoolsStatsQuery = exports.poolEpochRewardsQuery = exports.poolTotalProtocolFeesGeneratedQuery = exports.poolAvgRewardsQuery = exports.poolsAvgRewardsQuery = exports.sevenDayProtocolFeesGeneratedQuery = exports.poolSevenDayProtocolFeesGeneratedQuery = exports.stakingPoolByIdQuery = exports.stakingPoolsQuery = exports.epochNWithFeesQuery = exports.epochNQuery = exports.nextEpochQuery = exports.currentEpochWithFeesQuery = exports.currentEpochQuery = void 0;
exports.currentEpochQuery = `
    WITH zrx_staked AS (
        SELECT
...
exports.currentEpochWithFeesQuery = `
    WITH zrx_staked AS (
        SELECT
            SUM(esps.zrx_delegated) AS zrx_staked
        FROM staking.epoch_start_pool_status esps
...
WITH
    ...
    CROSS JOIN protocol_fees pf
;`;
exports.stakingPoolsQuery = `SELECT * FROM staking.pool_info;`;
exports.stakingPoolByIdQuery = `SELECT * FROM staking.pool_info WHERE pool_id = $1;`;
exports.poolSevenDayProtocolFeesGeneratedQuery = `
    ...
    WHERE
        p.pool_id = $1;
`;
exports.sevenDayProtocolFeesGeneratedQuery = `
    WITH pool_7d_fills AS (
        SELECT
            pi.pool_id
            , SUM(fe.protocol_fee_paid) / 1e18 AS protocol_fees
...
exports.poolAvgRewardsQuery = `
    WITH
        ...
        WHERE
            p.pool_id = $1;
`;
exports.poolTotalProtocolFeesGeneratedQuery = `
    WITH
...
`;
exports.currentEpochPoolsStatsQuery = `
    WITH
...
`;
exports.currentEpochPoolStatsQuery = `
    WITH
        current_epoch_beginning_status AS (
            SELECT
                esps.*
        ...
        WHERE
            pce.pool_id = $1;
`;
exports.nextEpochPoolsStatsQuery = `
    WITH
        current_stake AS (
            SELECT
                pi.pool_id
...
`;
exports.nextEpochPoolStatsQuery = `
    WITH
        current_stake AS (
            SELECT
                pi.pool_id
        ...
        WHERE pi.pool_id = $1;
`;
exports.currentEpochDelegatorDepositedQuery = `
    WITH
        delegator AS (
...
`;
exports.currentEpochDelegatorStakedQuery = `
    WITH
        delegator AS (
            SELECT $1::text AS delegator
        )
...
`;
exports.nextEpochDelegatorDepositedQuery = `
    WITH
        delegator AS (
            SELECT $1::text AS delegator
        )
    ...
    LEFT JOIN zrx_deposited zd ON zd.staker = d.delegator;
`;
exports.nextEpochDelegatorStakedQuery = `
    WITH
        delegator AS (
            SELECT $1::text AS delegator
        )
    ...
    LEFT JOIN zrx_staked zs ON zs.staker = d.delegator;
`;
exports.allTimeDelegatorStatsQuery = `
    SELECT
        pool_id
    ...
    GROUP BY 1;
`;
exports.allTimePoolRewardsQuery = `
    SELECT
        pool_id
...
//# sourceMappingURL=staking_queries.js.map